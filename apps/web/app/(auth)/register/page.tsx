...
const selectClass =
  "h-11 w-full rounded-xl border border-border bg-accent/5 px-3 text-base text-foreground outline-none transition-all focus:bg-background focus:ring-2 focus:ring-blue-500/20 dark:bg-white/5 sm:text-sm"
const inputClass =
