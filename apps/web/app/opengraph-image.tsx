  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <div style={{ display: "flex", marginTop: 40, fontSize: 28, color: "#94a3b8", maxWidth: 820 }}>
          AI coach, workplace scenarios, and developer vocabulary — built for foreign engineers in Korea.
        </div>
      </div>
    ),
    { ...size }
