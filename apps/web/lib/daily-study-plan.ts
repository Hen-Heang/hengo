...
const MODE_SCHEDULES: Record<DailyStudyMode, ActivityTemplate[]> = {
  busy: [
    ...
    { type: "shadowing", title: "Listening & shadowing", description: "Listen to today’s dialogue, then repeat each line aloud.", plannedStart: "19:10", estimatedMinutes: 10 },
    { type: "roleplay", title: "Voice speaking practice", description: "Answer today’s five spoken questions with the Korean coach.", plannedStart: "19:20", estimatedMinutes: 10 },
  ],
  normal: [
    ...
    { type: "shadowing", title: "Listening & shadowing", description: "Listen once, then shadow the practical dialogue three times.", plannedStart: "19:10", estimatedMinutes: 15 },
    ...
    { type: "roleplay", title: "GPT voice role-play", description: "Practice a workplace or daily-life scenario one question at a time.", plannedStart: "19:35", estimatedMinutes: 15 },
    { type: "correction_retry", title: "Correction & retry", description: "Retry corrected answers and record a short reflection.", plannedStart: "19:50", estimatedMinutes: 10 },
  ],
  office: [
    ...
    { type: "shadowing", title: "Three-dialogue shadowing block", description: "Listen to three dialogue passes and shadow each pass three times.", plannedStart: "10:30", estimatedMinutes: 25 },
    ...
    { type: "roleplay", title: "Workplace voice role-play", description: "Answer one practical question at a time and use formal 합니다체.", plannedStart: "15:00", estimatedMinutes: 30 },
    { type: "correction_retry", title: "Questions, retry & Korean diary", description: "Answer five questions, retry mistakes, then record a short Korean diary.", plannedStart: "17:20", estimatedMinutes: 30 },
  ],
}
...
export function getModeDuration(mode: DailyStudyMode): number {
  return generateModeSchedule(mode).reduce((total, activity) => total + activity.estimatedMinutes, 0)
}
...
export function buildDailyStudyContent(topicKey: string, studyDate: string): DailyStudyContent {
  ...
  return {
    ...
    dialogue: {
      ...
      lines: topic.category === "daily-life"
        ? [
