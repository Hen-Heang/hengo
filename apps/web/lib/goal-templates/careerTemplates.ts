      ...
      fields: [
        {
          id: "requiredSkills",
          type: "list",
          label: "Skills Needed for Target Role",
          placeholder: "e.g., Leadership, Project management, Technical expertise",
          required: true,
          minItems: 1,
          maxItems: 10,
        },
        {
          id: "currentStrengths",
          type: "list",
          label: "Your Current Strengths",
          placeholder: "e.g., Strong technical skills, Good communicator",
          required: true,
          minItems: 1,
          maxItems: 10,
        },
        {
          ...
          placeholder: "e.g., Public speaking, Strategic thinking, Stakeholder management",
          required: true,
          minItems: 1,
          maxItems: 10,
        },
      ...
      fields: [
        {
          id: "learningGoals",
          type: "list",
          label: "Learning/Training Goals",
          placeholder: "e.g., Complete leadership course, Get certification, Learn new technology",
          required: false,
          minItems: 0,
          maxItems: 10,
        },
        {
          id: "visibilityPlan",
          type: "list",
          label: "Ways to Increase Visibility",
          placeholder: "e.g., Lead projects, Present at meetings, Mentor juniors",
          required: false,
          minItems: 0,
          maxItems: 10,
        },
      ...
      fields: [
        {
          id: "hustleIdea",
          type: "text",
          label: "Side Hustle Idea",
          placeholder: "e.g., Freelance web design, Online tutoring, E-commerce store",
          required: true,
        },
        {
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          id: "skills",
          type: "list",
          label: "Relevant Skills You Have",
          placeholder: "e.g., Coding, Writing, Marketing, Design",
          required: true,
          minItems: 1,
          maxItems: 10,
        },
        {
          ...
          placeholder: "e.g., SEO, Social media marketing, Bookkeeping",
          required: false,
          minItems: 0,
          maxItems: 10,
        },
      ...
      fields: [
        {
          ...
          placeholder: "e.g., Small businesses, Students, Fitness enthusiasts",
          required: true,
        },
        {
          id: "marketingPlan",
          ...
          placeholder: "e.g., Instagram, LinkedIn, Referrals, Local ads",
          required: true,
          minItems: 1,
          maxItems: 10,
        },
        {
          ...
          placeholder: "e.g., First 3 clients, $500 revenue, Launch MVP",
          required: true,
        },
      ],
    },
...
export const jobSearchTemplate: GoalTemplate = {
      ...
      fields: [
        {
          ...
          type: "number",
          label: "Applications Per Week Goal",
          placeholder: "10",
          required: true,
          min: 1,
          max: 50,
        },
        {
          ...
          placeholder: "e.g., LinkedIn, Indeed, Company sites, Glassdoor",
          required: true,
          minItems: 1,
          maxItems: 10,
        },
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          id: "interviewPrep",
          type: "list",
          label: "Interview Skills to Practice",
          placeholder: "e.g., Technical interviews, Behavioral questions, Salary negotiation",
          required: false,
          minItems: 0,
          maxItems: 10,
        },
  ...
  generatePrompt: (data) => {
    const weeksInTimeline =
      data.jobSearchTimeline === "1-2" ? 8 : data.jobSearchTimeline === "3-4" ? 16 : 24
      ...
      fields: [
        {
          id: "targetSkill",
          type: "text",
          label: "Skill to Master",
          placeholder: "e.g., Data Analysis, Public Speaking, Leadership",
          required: true,
        },
        {
          id: "currentLevel",
        ...
        },
        {
          ...
          placeholder: "e.g., Required for promotion, Market demand, Personal passion",
          required: true,
        },
      ],
    },
      ...
      fields: [
        {
          id: "hoursPerWeek",
          type: "number",
          label: "Hours Per Week to Practice",
          placeholder: "5",
          required: true,
          min: 1,
          max: 40,
        },
        {
          ...
          placeholder: "e.g., Online course, Books, Mentorship, Projects",
          required: true,
          minItems: 1,
          maxItems: 10,
        },
        {
          ...
          placeholder: "e.g., Side projects, Volunteer work, Work assignments, Teaching others",
          required: true,
          minItems: 1,
          maxItems: 10,
        },
      ...
      fields: [
        {
          ...
          placeholder: "e.g., Complete certification, Build 3 projects, Give presentation",
          required: true,
          minItems: 1,
          maxItems: 10,
        },
