      ...
      fields: [
        {
          ...
          placeholder: "e.g., Apps (Duolingo), Classes, Tutors, Videos",
          required: true,
          minItems: 1,
          maxItems: 5,
        },
      ...
      fields: [
        {
          id: "purpose",
          type: "textarea",
          label: "Why are you learning this language?",
          placeholder: "e.g., Travel, work, connect with family, personal interest",
          required: true,
        },
        {
          id: "milestones",
          ...
          placeholder:
            "e.g., Order food at restaurant, Have 5-minute conversation, Watch movie without subtitles",
          required: false,
          minItems: 0,
          maxItems: 10,
        },
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          placeholder: "e.g., freeCodeCamp, Udemy, YouTube, Documentation",
          required: true,
          minItems: 1,
          maxItems: 5,
        },
        {
          ...
          type: "list",
          label: "Project Ideas",
          placeholder: "e.g., Todo app, Portfolio website, Discord bot",
          required: false,
          minItems: 0,
          maxItems: 10,
        },
  ...
  sections: [
    {
      ...
      fields: [
        ...
        },
        {
          ...
          placeholder: "e.g., Fiction, Self-help, Business, History",
          required: true,
          minItems: 1,
          maxItems: 10,
        },
        {
          id: "bookList",
          type: "list",
          label: "Books on Your List (Optional)",
          placeholder: "e.g., Atomic Habits, 1984, Sapiens",
          required: false,
          minItems: 0,
          maxItems: 50,
        },
