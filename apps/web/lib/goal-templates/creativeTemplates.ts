...
export const writeBookTemplate: GoalTemplate = {
  ...
  sections: [
    {
      ...
      fields: [
        ...
        },
        {
          id: "bookPremise",
          type: "text",
          label: "Book Premise (1 sentence)",
          placeholder: "e.g., A coming-of-age story about overcoming adversity through friendship",
          required: true,
        },
      ],
    },
    {
      ...
      fields: [
        ...
        {
          id: "targetCompletionMonths",
          type: "number",
          label: "Target Completion (months)",
          placeholder: "6",
          required: true,
          min: 1,
          max: 36,
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          placeholder: "e.g., Writing group, Beta readers, Writing coach, Online community",
          required: false,
          minItems: 0,
          maxItems: 10,
        },
        {
          ...
          placeholder: "e.g., Writer's block, Time management, Self-doubt, Lack of structure",
          required: false,
          minItems: 0,
          maxItems: 10,
        },
  ...
  generatePrompt: (data) => {
    const totalDays =
      (data.wordsPerDay as number) > 0
        ? Math.ceil((data.targetWordCount as number) / (data.wordsPerDay as number))
        : 0
      ...
      fields: [
        {
          id: "songsToLearn",
          type: "list",
          label: "Songs You Want to Play",
          placeholder: "e.g., Wonderwall, Let It Be, Sweet Child O' Mine",
          required: false,
          minItems: 0,
          maxItems: 10,
        },
        {
          id: "skillGoals",
          type: "list",
          label: "Technical Skills to Master",
          placeholder: "e.g., Read sheet music, Finger picking, Improvisation, Play by ear",
          required: false,
          minItems: 0,
          maxItems: 10,
        },
        {
          id: "performanceGoal",
          type: "text",
          label: "Performance Milestone (Optional)",
          placeholder: "e.g., Play at open mic, Record a cover, Perform for family",
          required: false,
        },
      ],
    },
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          placeholder: "e.g., YouTube tutorials, Online course, Photography books, Local workshops",
          required: true,
          minItems: 1,
          maxItems: 10,
        },
      ...
      fields: [
        {
          ...
          label: "Technical Skills to Master",
          placeholder:
            "e.g., Manual mode, Composition, Lighting, Editing (Lightroom), RAW processing",
          required: true,
          minItems: 1,
          maxItems: 10,
        },
        ...
        },
        {
          ...
          placeholder:
            "e.g., 30-day photo challenge, Client photoshoot, Exhibition, Instagram following",
          required: false,
          minItems: 0,
          maxItems: 10,
        },
...
export const artSkillTemplate: GoalTemplate = {
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          type: "list",
          label: "Learning Resources",
          placeholder: "e.g., Drawabox, YouTube, Skillshare, Art books, Local classes",
          required: true,
          minItems: 1,
          maxItems: 10,
        },
      ...
      fields: [
        {
          ...
          placeholder: "e.g., Anatomy, Perspective, Color theory, Shading, Composition",
          required: true,
          minItems: 1,
          maxItems: 10,
        },
        {
          ...
          label: "Project Ideas",
          placeholder:
            "e.g., 100 day challenge, Portrait series, Character designs, Landscape studies",
          required: false,
          minItems: 0,
          maxItems: 10,
        },
  ...
  generatePrompt: (data) => {
    const weeklyHours = (
      ((data.practiceTime as number) * (data.sessionPerWeek as number)) /
      60
    ).toFixed(1)
