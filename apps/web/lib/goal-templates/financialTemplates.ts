    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          id: "saveDay",
          type: "select",
          label: "When to Transfer Savings",
          required: true,
          options: [
      ...
      fields: [
        {
          id: "cutExpenses",
          type: "list",
          label: "Expenses to Reduce (Optional)",
          placeholder: "e.g., Dining out, Subscriptions, Coffee",
          required: false,
          minItems: 0,
          maxItems: 10,
        },
        {
          id: "incomeBoost",
          type: "list",
          label: "Ways to Increase Income (Optional)",
          placeholder: "e.g., Freelancing, Sell unused items, Side gig",
          required: false,
          minItems: 0,
          maxItems: 10,
        },
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          type: "list",
          label: "Types of Debt",
          placeholder: "e.g., Credit card $5000 @ 18%, Car loan $8000 @ 5%, Student loan $2000",
          required: true,
          minItems: 1,
          maxItems: 10,
        },
      ...
      fields: [
        {
          id: "incomeBoost",
          type: "list",
          label: "Ways to Increase Income",
          placeholder: "e.g., Overtime, Side hustle, Sell items",
          required: false,
          minItems: 0,
          maxItems: 10,
        },
        {
          id: "expenseCuts",
          type: "list",
          label: "Expenses to Cut",
          placeholder: "e.g., Cancel subscriptions, Reduce dining out",
          required: false,
          minItems: 0,
          maxItems: 10,
        },
...
export const investmentPortfolioTemplate: GoalTemplate = {
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          id: "investmentTypes",
          type: "list",
          label: "Interested Investment Types",
          placeholder: "e.g., Index funds, ETFs, Stocks, Bonds, Real estate",
          required: true,
          minItems: 1,
          maxItems: 10,
        },
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          placeholder: "e.g., Vanguard, Fidelity, Robinhood",
          required: false,
        },
      ],
    },
  ...
  generatePrompt: (data) => {
    const yearlyContribution =
      (data.monthlyContribution as number) * 12 + (data.initialInvestment as number)
