      ...
      fields: [
        {
          id: "goals",
          type: "list",
          label: "What You Hope to Achieve",
          placeholder: "e.g., Reduce stress, Improve focus, Better sleep, Emotional balance",
          required: true,
          minItems: 1,
          maxItems: 10,
        },
      ...
      fields: [
        {
          id: "location",
          type: "text",
          label: "Meditation Location",
          placeholder: "e.g., Bedroom, Living room, Outdoor space",
          required: true,
        },
        {
          id: "tools",
          type: "list",
          label: "Tools/Resources to Use",
          placeholder: "e.g., Headspace app, Cushion, Timer, Calm app",
          required: false,
          minItems: 0,
          maxItems: 10,
        },
        {
          ...
          placeholder: "e.g., Busy mornings, Distractions, Falling asleep, Restless mind",
          required: false,
          minItems: 0,
          maxItems: 10,
        },
  ...
  sections: [
    {
      ...
      fields: [
        ...
        },
        {
          id: "speakingContext",
          type: "list",
          label: "Speaking Contexts",
          placeholder: "e.g., Work presentations, Conferences, Community events, Teaching",
          required: true,
          minItems: 1,
          maxItems: 10,
        },
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          placeholder:
            "e.g., Mirror practice, Record videos, Join Toastmasters, Present to friends",
          required: true,
          minItems: 1,
          maxItems: 10,
        },
        {
          id: "realOpportunities",
          type: "list",
          label: "Real Speaking Opportunities",
          placeholder: "e.g., Team meetings, Volunteer to present, Local meetups, Conference talks",
          required: true,
          minItems: 1,
          maxItems: 10,
        },
      ...
      fields: [
        {
          ...
          placeholder:
            "e.g., Managing anxiety, Clear delivery, Engaging audience, Body language, Storytelling",
          required: true,
          minItems: 1,
          maxItems: 10,
        },
        {
          id: "milestones",
          type: "list",
          label: "Speaking Milestones",
          placeholder:
            "e.g., Give 5-minute talk, Present at work, Speak at meetup, Conference presentation",
          required: true,
          minItems: 1,
          maxItems: 10,
        },
  ...
  sections: [
    {
      ...
      fields: [
        ...
        },
        {
          id: "routineDuration",
          type: "number",
          label: "Morning Routine Duration (minutes)",
          placeholder: "60",
          required: true,
          min: 15,
          max: 240,
        ...
        },
        {
          id: "nightOwl",
          type: "select",
          label: "Natural Sleep Preference",
          required: true,
          options: [
      ...
      fields: [
        {
          ...
          placeholder: "e.g., Exercise, Meditation, Breakfast, Shower, Reading",
          required: true,
          minItems: 1,
          maxItems: 10,
        },
        {
          id: "niceToHave",
          type: "list",
          label: "Nice-to-Have Activities",
          placeholder: "e.g., Journaling, Stretching, Coffee ritual, Planning day",
          required: false,
          minItems: 0,
          maxItems: 10,
        },
        {
          id: "eliminateHabits",
          type: "list",
          label: "Morning Habits to Eliminate",
          placeholder:
            "e.g., Hitting snooze, Checking phone immediately, Rushing, Skipping breakfast",
          required: false,
          minItems: 0,
          maxItems: 10,
        },
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          placeholder: "e.g., Late nights, Kids waking up, Poor sleep quality, No motivation",
          required: false,
          minItems: 0,
          maxItems: 10,
        },
  ...
  sections: [
    {
      ...
      fields: [
        {
          id: "currentHoursPerDay",
          type: "number",
          label: "Current Screen Time (hours/day)",
          placeholder: "6",
          required: true,
          min: 0,
          max: 24,
        ...
        },
        {
          ...
          type: "number",
          label: "Target Screen Time (hours/day)",
          placeholder: "3",
          required: true,
          min: 0,
          max: 24,
        ...
        },
        {
          id: "problematicApps",
          type: "list",
          label: "Most Time-Consuming Apps",
          placeholder: "e.g., Instagram, YouTube, TikTok, Twitter, Games",
          required: true,
          minItems: 1,
          maxItems: 10,
        },
        {
          id: "reasonsToReduce",
          type: "list",
          label: "Why Reduce Screen Time?",
          placeholder:
            "e.g., More quality time, Better sleep, Increased productivity, Less anxiety",
          required: true,
          minItems: 1,
          maxItems: 10,
        },
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          id: "phoneFreeTimes",
          type: "list",
          label: "Phone-Free Times",
          placeholder: "e.g., First hour after waking, During meals, After 9 PM, Family time",
          required: true,
          minItems: 1,
          maxItems: 10,
        },
        {
          id: "replacementActivities",
          type: "list",
          label: "Activities to Replace Screen Time",
          placeholder: "e.g., Reading, Exercise, Hobbies, Socializing, Nature walks",
          required: true,
          minItems: 1,
          maxItems: 10,
        },
      ...
      fields: [
        {
          id: "toolsToUse",
          type: "list",
          label: "Screen Time Management Tools",
          placeholder:
            "e.g., App limits, Grayscale mode, Freedom app, Notification blocking, Phone lockbox",
          required: false,
          minItems: 0,
          maxItems: 10,
        },
