      ...
      {REVIEW_LINKS.map(({ href, label, icon: Icon }) => {
        ...
        return (
          <Link
            ...
            className={cn(
              "flex min-h-11 flex-1 items-center justify-center gap-2 rounded-xl px-3 py-2 text-sm font-bold outline-none transition-all focus-visible:ring-2 focus-visible:ring-ring/70 active:scale-[0.98]",
              active
